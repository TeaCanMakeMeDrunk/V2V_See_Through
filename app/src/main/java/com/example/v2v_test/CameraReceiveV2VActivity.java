...
public class CameraReceiveV2VActivity extends DemoBase {
    //无地图定位的接收，有时延分析
    boolean flag = true;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setTitle("DSRC Video Receive");
        setContentView(R.layout.activity_camera_v2v_receive);
            ...
            public boolean handleMessage(Message msg) {
                switch (msg.what) {
                    case 1://图片
                        ...
                        CameraReceiveV2VActivity.this.picSize.setText("totalSize：" + (int) data.get("totalSize") / 1024 + "KB");
                        //先显示图片，再画时延表
...
//        set1.setLineWidth(1.5f);
        ...
        // create a lineData object with the lineData sets
        LineData lineData = new LineData(set1);
        // set lineData
        chart.setData(lineData);

        //曲线最大可见范围
        chart.setVisibleXRangeMaximum(125);
//        chart.setVisibleYRangeMaximum(250f,YAxis.AxisDependency.LEFT);
        chart.setVisibleYRange(25f,250f,YAxis.AxisDependency.LEFT);
        //设置曲线移动，向左，moveViewToX()会自动调用 chart.invalidate();
