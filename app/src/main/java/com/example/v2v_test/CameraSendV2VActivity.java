...
import com.example.v2v_test.UDP.Send;
...
public class CameraSendV2VActivity extends AppCompatActivity{
    //不要地图
    //相机相关
...
//                Log.i("info", "take photo");
                ...
                try {
                    send.sendPicture(MainActivity.IP, MainActivity.PORT, bitmap,(double)index++);
                } catch (IOException e) {
                    e.printStackTrace();
                }
                image.close();
...
//        ORIENTATIONS.append(Surface.ROTATION_270, 180);
    ...
    public void takePictureOnclick() {
        //新建子线程一直发图片，以达到视频传输
        Timer takePhotoTimer= new Timer();
        //1s传输10张图  25
        takePhotoTimer.schedule(new TakePhotoTimerTask(),0,100);
//        new Thread() {
//            @Override
//            public void run() {
//                keepRunning = true;
...
//        }.start();
    ...
    class TakePhotoTimerTask extends TimerTask {
        @Override
        public void run(){
            takePicture();
        }
