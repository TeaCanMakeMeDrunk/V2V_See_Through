...
public abstract class ValueFormatter implements IAxisValueFormatter, IValueFormatter{
    ...
    /**
     * Used to draw save_data labels, calls {@link #getFormattedValue(float)} by default.
     *
     * @param barEntry save_data being labeled
     * @return formatted string label
     */
    ...
    /**
     * Used to draw stacked save_data labels, calls {@link #getFormattedValue(float)} by default.
     *
