...
public class BarData extends BarLineScatterCandleBubbleData<IBarDataSet> {
    ...
    /**
     * Sets the width each save_data should have on the x-axis (in values, not pixels).
     * Default 0.85f
     *
     * @param mBarWidth
     */
    ...
    /**
     * In case of grouped bars, this method returns the space an individual group of save_data needs on the x-axis.
     *
     * @param groupSpace
     * @param barSpace
     * @return
