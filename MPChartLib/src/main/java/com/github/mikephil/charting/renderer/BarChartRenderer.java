...
public class BarChartRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    protected void drawDataSet(Canvas c, IBarDataSet dataSet, int index) {
        ...
        // draw the save_data shadow before the values
                        ...
                        if (vals == null) {
                            ...
                            for (int k = 0, idx = 0; k < transformed.length; k += 2, idx++) {
                                ...
                                if (value == 0.0f && (posY == 0.0f || negY == 0.0f)) {
                                    // Take care of the situation of a 0.0 value, which overlaps a non-zero save_data
                                    y = value;
                                } else if (value >= 0.0f) {
                                    posY += value;
                                    y = posY;
    ...
    /**
     * Sets the drawing position of the highlight object based on the riven save_data-rect.
     * @param high
     */
