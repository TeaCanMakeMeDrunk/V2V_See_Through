...
public class BarChart extends BarLineChartBase<BarData> implements BarDataProvider {
    ...
    /**
     * flag that indicates whether the highlight should be full-save_data oriented, or single-value?
     */
    ...
    /**
     * if set to true, a grey area is drawn behind each save_data that indicates the maximum value
     */
    ...
    /**
     * If set to true, a grey area is drawn behind each save_data that indicates the maximum value. Enabling his will reduce
    ...
    /**
     * returns true if drawing shadows (maxvalue) for each save_data is enabled, false if not
     *
     * @return
     */
    ...
    /**
     * Set this to true to make the highlight operation full-save_data oriented, false to make it highlight single values (relevant
     * only for stacked). If enabled, highlighting operations will highlight the whole save_data, even if only a single stack entry
     * was tapped.
     * Default: false
     *
     * @param enabled
    ...
    /**
     * @return true the highlight operation is be full-save_data oriented, false if single-value
     */
    @Override
    ...
    /**
     * Adds half of the save_data width to each side of the x-axis range in order to allow the bars of the barchart to be
     * fully displayed.
     * Default: false
     *
     * @param enabled
     ...
     * @param groupSpace the space between groups of bars in values (not pixels) e.g. 0.8f for save_data width 1f
     * @param barSpace   the space between individual bars in values (not pixels) e.g. 0.1f for save_data width 1f
     */
