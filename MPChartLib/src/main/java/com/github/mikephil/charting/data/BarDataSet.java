...
public class BarDataSet extends BarLineScatterCandleBubbleDataSet<BarEntry> implements IBarDataSet {
    ...
    /**
     * the color used for drawing the save_data shadows
     */
    ...
    /**
     * the alpha value used to draw the highlight indicator save_data
     */
    ...
    /**
     * Sets the color used for drawing the save_data-shadows. The save_data shadows is a
     * surface behind the save_data that indicates the maximum value. Don't for get to
     ...
     * indicator save_data. min = 0 (fully transparent), max = 255 (fully opaque)
     *
     * @param alpha
     */
    ...
    /**
     * Sets labels for different values of save_data-stacks, in case there are one.
     *
     * @param labels
     */
