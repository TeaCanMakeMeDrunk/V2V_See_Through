...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
    ...
    /**
     * Returns the left y-axis object. In the horizontal save_data-chart, this is the
     * top axis.
     *
     * @return
     */
    ...
    /**
     * Returns the right y-axis object. In the horizontal save_data-chart, this is the
     * bottom axis.
     *
     * @return
     */
     ...
     * horizontal save_data-chart, LEFT == top, RIGHT == BOTTOM
     *
     * @param axis
     * @return
     */
