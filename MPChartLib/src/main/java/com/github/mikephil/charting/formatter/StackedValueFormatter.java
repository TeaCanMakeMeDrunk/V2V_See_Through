...
public class StackedValueFormatter extends ValueFormatter
{
    ...
    /**
     * if true, all stack values of the stacked save_data entry are drawn, else only top
     */
     ...
     * Constructor.
     *
     * @param drawWholeStack if true, all stack values of the stacked save_data entry are drawn, else only top
