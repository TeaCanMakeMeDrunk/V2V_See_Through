...
public interface IDataSet<T extends Entry> {
     ...
     *
     * NOTE (for save_data and line charts): if `maxVisibleCount` is reached, no values will be drawn even
     * if this is enabled
     * @param enabled
     */
     ...
     *
     * NOTE (for save_data and line charts): if `maxVisibleCount` is reached, no icons will be drawn even
     * if this is enabled
     *
     * @param enabled
     */
