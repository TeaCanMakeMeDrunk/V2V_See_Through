...
public interface IBarDataSet extends IBarLineScatterCandleBubbleDataSet<BarEntry> {
    ...
    /**
     * Returns the color used for drawing the save_data-shadows. The save_data shadows is a
     * surface behind the save_data that indicates the maximum value.
     *
     * @return
     */
     ...
     * This is only relevant for stacked save_data entries.
     *
     * @return
     */
